...
\begin{itemize}
  \item[$\circ$] Income support programs and health: evidence is mixed
    \begin{itemize}
      ...
      \item Some identify unintended adverse consequences \smallcite{FernaldGertlerHou2008JN}
    \end{itemize}
  \vspace{4pt}
  ...
  \item[$\circ$] CCTs have been widely studied for children, but \textbf{elderly} has been overlooked
    \begin{itemize}
      ...
      \item \smallcite{BarhamRowberry2013JDE}: \textit{short-run} reductions in elderly mortality over first years
    \end{itemize}
  \vspace{4pt}
