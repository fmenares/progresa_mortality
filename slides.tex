...
\begin{itemize}
  ...
  \item[$\circ$] \textbf{Event study reveals additional concern for BR sample:}
    \begin{itemize}
      ...
      \item Neither sex supports the $-3.97$ pooled estimate
    \end{itemize}
  \vspace{6pt}
...
\end{equation*}
\vspace{-6pt}
{\footnotesize $\delta_t$: treatment effect in year $t$ relative to control at 1997 baseline. Treatment randomized at locality level $\Rightarrow$ no additional controls needed. SE clustered at locality level.}
...
\begin{frame}<0|handout:0>[noframenumbering, plain, allowframebreaks]{}
