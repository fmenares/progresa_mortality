...
\begin{frame}
  \titlepage
  \footnotetext{$^{*}$\scriptsize The opinions expressed in this paper are those of the authors and do not necessarily reflect the views of the Inter-American Development Bank, its Board of Directors, or the countries they represent, nor of INEGI.}
\vfill
\end{frame}
}
...
\begin{frame}{Figure A.6 --- Event Study by Sex and Sample, 1992--2002}\label{fig_a6}
\vskip -2mm
\begin{figure}
  \centering
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \vspace{2pt}
      \includegraphics[width=\textwidth, height=0.38\textheight, keepaspectratio]{appendix/Figure_6_emr65f_BR.pdf}
    \end{column}
    \begin{column}{0.5\textwidth}
      \centering {\small (b) High Marginalization --- Females}\\
      \vspace{2pt}
      \includegraphics[width=\textwidth, height=0.38\textheight, keepaspectratio]{appendix/Figure_6_emr65f_HighMarg.pdf}
    \end{column}
  \end{columns}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \vspace{2pt}
      \includegraphics[width=\textwidth, height=0.38\textheight, keepaspectratio]{appendix/Figure_6_emr65m_BR.pdf}
    \end{column}
    \begin{column}{0.5\textwidth}
      \centering {\small (d) High Marginalization --- Males}\\
      \vspace{2pt}
      \includegraphics[width=\textwidth, height=0.38\textheight, keepaspectratio]{appendix/Figure_6_emr65m_HighMarg.pdf}
    \end{column}
  \end{columns}
\end{figure}
\end{frame}
