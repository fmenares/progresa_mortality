...
Our sample differs from that used by \cite{BarhamRowberry2013JDE} in an important way. They select municipalities incorporated into Progresa in 1998 or 1999—early adopters where program rollout was fastest and enrollment density was highest in the initial years. This is a compact, homogeneous sample well-suited to identifying short-run effects. We instead restrict to all highly marginalized municipalities regardless of exact enrollment timing, capturing the full population of the program's original high-poverty target areas over a longer horizon (1991--2006 versus approximately 1990--2000). The two samples partially overlap: many early-adopting municipalities are also highly marginalized, but ours additionally includes municipalities that enrolled later yet were equally poor. Appendix Figure~\ref{f:es_dd_sex_no_weight_app3} directly compares event study estimates across both sample definitions, allowing the reader to assess whether the null finding is specific to our sample choice or consistent across both.\footnote{Figure A.1 in the appendix further documents the spatial distribution of Progresa intensity across all municipalities and separately for the highly marginalized subsample, confirming substantial variation in both early-phase (1999) and late-phase (2005) enrollment.}
