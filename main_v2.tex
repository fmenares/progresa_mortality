...
Our approach does not share this requirement. We exploit cross-sectional variation in program coverage across municipalities rather than within-municipality changes over time. Under our design, a municipality with high $\textit{Intensity}_{1999}$ serves as a high-treatment observation regardless of the exact year it was phased in, and a municipality with low $\textit{Intensity}_{1999}$ serves as a lower-treatment comparison—so long as the intensity measure is informative about actual coverage. This is the crux of the measurement issue: $\textit{Intensity}_{1999}$ is highly informative for early-adopting municipalities, but for municipalities incorporated after 1999, it records a near-zero value not because they received little program, but simply because their enrollment had not yet begun. Including such municipalities in the short-run replication compresses the identifying variation and attenuates the estimated coefficient toward zero—a measurement artefact, not a true null effect. Our long-run design resolves this by assigning $\textit{Intensity}_{2005}$ to the later wave of adopters, giving each group its own valid intensity measure. This is why our preferred specification includes all highly marginalized municipalities without a phase-in timing restriction: the two fixed intensity measures jointly encode the phase-in timing without requiring us to drop any municipality from the sample. Appendix Figure~\ref{f:es_dd_sex_no_weight_app3} directly compares event study estimates across both sample definitions.\footnote{Figure~\ref{f:variation} in the appendix documents the spatial distribution of Progresa intensity across all municipalities and separately for the highly marginalized subsample, confirming substantial variation in both early-phase (1999) and late-phase (2005) enrollment.}
