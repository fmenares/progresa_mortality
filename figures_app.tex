...
%------------------------------------------------------------
% NEW, additional figure -- generated by codes/02_mortality.do,
% immediately after the AF8_beta0_stability block. PROVISIONAL -- the
% PDF below is a placeholder pending a real Stata run; swap in the real
% AF8b_beta0_stability_2002ctrl.pdf output and drop the
% \textcolor{red}{} once reviewed. NOT YET referenced anywhere in
% main.tex, per instruction.
%------------------------------------------------------------
\textcolor{red}{
\begin{figure}[H]
    \caption{Event Study: Stability of the Early-Phase (Intensity 1999) Coefficient to the Choice of Second-Phase Control, Including the Intensity 2002 Snapshot}
    \label{af:beta0_stability_2002ctrl}

{\includegraphics[width=0.85\textwidth]{figures/appendix/AF8b_beta0_stability_2002ctrl.pdf}}

         \floatfoot{Notes: PROVISIONAL -- pending a Stata run. This figure reproduces Appendix Figure~\ref{af:beta0_stability}, adding a fifth series that controls for the $\textit{Intensity}_{2002}$ snapshot instead of the later-phase intensity measures shown there. This mid-phase snapshot is deliberately excluded from Appendix Figure~\ref{af:beta0_stability}'s baseline comparison, since mid-phase the roll-out is still ramping up and such a control can absorb part of the early-phase variation the design is meant to isolate; it is included here as an additional sensitivity check. All specifications include Seguro Popular intensity, municipality and year fixed effects, and are weighted by the population aged 65 and older. The vertical line marks the program's 1997 rollout. The sample is restricted to highly marginalized municipalities. 95\% confidence intervals shown.}
\end{figure}
}
