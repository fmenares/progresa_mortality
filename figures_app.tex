...
{\includegraphics[width=0.49\textwidth]{figures/appendix/AF9d2_emr65m_HighMarg_2002ctrl.pdf}}
         ...
         \floatfoot{Notes: Notes: This figure compares event study estimates across the two sample definitions used in this paper and in Barham and Rowberry (2013) for the baseline specification and one including a later-phase control (1997-2002). Solid vertical lines corresponde to the confidence intervals of the baseline weighted point estimates from specification in Figure \ref{af:es_sample_compare}, and the dashed confidence intervals corresponds baseline event study controlling for $\textit{Intensity}_{2002}$ interacted with year indicators -- the event-study analogue of the $\textit{Intensity}_{2002}$ control column in Appendix Table~\ref{at:did_robust_br2_2002ctrl_eoy}. Left panels (BR) restrict to municipalities incorporated into Progresa in 1998 or 1999; right panels (HM) restrict to highly marginalized municipalities. All regressions include municipality and year fixed effects; the reference year is 1996; the period is 1992--2002. 95\% confidence intervals shown.}
\end{figure}
