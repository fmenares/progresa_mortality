...
%------------------------------------------------------------
% NEW, additional companion figure to af:es_sample_compare above --
% generated by codes/02_mortality.do, in the same block (the wsp2002
% spec added there). PROVISIONAL -- the PDFs below are placeholders
% pending a real Stata run; swap in the real AF9a2-d2_..._2002ctrl.pdf
% outputs and drop the \textcolor{red}{} once reviewed. NOT YET
% referenced anywhere in main.tex, per instruction.
%------------------------------------------------------------
\textcolor{red}{
\begin{figure}[H]
    \caption{Event Study: Effect of Progresa Enrollment Intensity on Mortality Rate by Sex and Sample, 1992--2002, With an Intensity 2002 Control}
    \label{af:es_sample_compare_2002ctrl}

\subfigure[Phase in 1998/1999 - Females]
{\includegraphics[width=0.49\textwidth]{figures/appendix/AF9a2_emr65f_BR_2002ctrl.pdf}}
\subfigure[Highly Marginalized - Females]
     {\includegraphics[width=0.49\textwidth]{figures/appendix/AF9b2_emr65f_HighMarg_2002ctrl.pdf}}

\subfigure[Phase in 1998/1999 - Males]
{\includegraphics[width=0.49\textwidth]{figures/appendix/AF9c2_emr65m_BR_2002ctrl.pdf}}
 \subfigure[Highly Marginalized - Males]
{\includegraphics[width=0.49\textwidth]{figures/appendix/AF9d2_emr65m_HighMarg_2002ctrl.pdf}}

         \floatfoot{Notes: PROVISIONAL -- pending a Stata run. This figure is a companion to Appendix Figure~\ref{af:es_sample_compare}, overlaying that figure's weighted-plus-Seguro-Popular baseline event study with the same specification additionally controlling for $\textit{Intensity}_{2002}$ interacted with year indicators -- the event-study analogue of the $\textit{Intensity}_{2002}$ control column in Appendix Table~\ref{at:did_robust_br2_2002ctrl_eoy}. Left panels (BR) restrict to municipalities incorporated into Progresa in 1998 or 1999; right panels (HM) restrict to highly marginalized municipalities. All regressions include municipality and year fixed effects; the reference year is 1996; the period is 1992--2002. 95\% confidence intervals shown.}
\end{figure}
}


\begin{figure}[H]
    \caption{Event Study: Effect of Progresa Enrollment Intensity on Older Adults' Mortality Rate by Sex, Without a Later-Phase Control}
    \label{af:no_control_es}
\subfigure[Pooled]
{\includegraphics[width=0.6\textwidth]{figures/appendix/AF10a_no_control_p.pdf}}

\subfigure[Female]
{\includegraphics[width=0.49\textwidth]{figures/appendix/AF10b_no_control_f.pdf}}
\subfigure[Male]
{\includegraphics[width=0.49\textwidth]{figures/appendix/AF10c_no_control_m.pdf}}

         \floatfoot{Notes: This figure presents event-study estimates of the interaction between $\textit{Intensity}_{1999}$ and year indicators (reference year 1996) for the pooled, female, and male older-adult (65+) mortality rate per 1,000 inhabitants, with no later-phase (cumulative enrollment) intensity control included. All specifications include Seguro Popular intensity, municipality and year fixed effects, and are weighted by the population aged 65 and older. The vertical line marks the program's 1997 rollout. The sample is restricted to highly marginalized municipalities. 95\% confidence intervals shown.}
\end{figure}
