...
%------------------------------------------------------------
% Companion figure to af:es_sample_compare above -- generated by
% codes/04_extra_robustness.do (moved there from codes/02_mortality.do
% per the coauthor's request; still live/displayed, unlike that file's
% other moved-and-hidden blocks).
%------------------------------------------------------------
\begin{figure}[H]
