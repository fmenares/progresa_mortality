...
% \begin{figure}[H]
%     \caption{\textit{70 y Más} Effect on Mortality Rates}
%     \label{f:mortality}
%        \subfigure[Mortality Rate]
%      {\includegraphics[width=0.67\textwidth]{figures/raw_data/death_rates_nc_2007_second_60_79.pdf}}
     
%    \subfigure[Event Study]
%      {\includegraphics[width=0.67\textwidth]{figures/event_study/10yr/Figure_2a_2007.pdf}}

%          \floatfoot{Notes: Panel (a) presents age-adjusted mortality rates above and below 70 years old for the 2007 eligible localities for \textit{70 y Más} expansion and the preferred comparison group of localities sizes 30,000-100,000. Panel (b): shows the results obtained from estimating the dynamic difference-in-difference-in-differences using the count of deaths as the dependent variable in a Poisson regression including the logarithm of population as an offset, and controlling for locality, age, and year fixed effects, as well as locality-age eligibility, year-locality eligibility, and year-age eligibility fixed effects. Standard errors are clustered at the level of treatment: locality and age. The mortality rate in the y-axis corresponds to percent changes by subtracting 1 from the rate ratio, i.e., $\hat{\theta}_{ATT\% } = exp(\hat{\beta})-1$. 95\% confidence intervals for $\hat{\theta}_{ATT\%}$ are computed using the delta method for univariate transformations on the coefficient estimated from the Poisson regression. The period of analysis is from 2002 to 2011. All regressions are weighted using the locality population aged 60 to 79 in 2005. The population offset is interpolated from the 2000, 2005, and 2010 Census data at the locality-age-year level.}
% \end{figure}
...
\floatbox[{\captop}]{table}[\FBwidth]
  {}
  {\scalebox{0.9}{
      \input{tables/appendix/A_T1_robustness}
    }
    \vspace{-3mm}
...
a. The study period is between 1992 and 2002 (n = 1,961; n-years = 21,571).\\ 
b. The study period is between 1992 and 2002 (n = 1,422; n-years = 15,642).\\
c. The study period is between 1992 and 2002 (n = 1,422; n-years = 15,642). \\
d. The study period is between 1991 and 2001 (n = 1,422; n-years = 15,642).\\ 
e. The study period is between 1993 and 2003 (n = 1,422; n-years = 15,642).\\ 
***p$<0.01$, **p$<0.05$, *p$<0.1$.}
  }
\end{table}
\newpage
...
%1997 interaction Up to 2002, replacting short term effects on BR
%This results almost the same as the long-term effects, reassuring there are no
%many results..
...
%     {}
%     {\scalebox{0.7}{
%     \input{tables/main/T1_ind_enigh_1997_2002}
%     }
%     \vspace{-3mm}
...
%     {}
%     {\scalebox{0.7}{
%     \input{tables/main/T2_hh_enigh_1997_2002}
%     }
%     \vspace{-3mm}
...
%     {}
%     {\scalebox{0.7}{
%     \input{tables/main/T3_food_enigh_1997_2002}
%     }
%     \vspace{-3mm}
...
%     {}
%     {\scalebox{0.7}{
%     \input{tables/main/T4_health_enigh_1997_2002}
%     }
%     \vspace{-3mm}
