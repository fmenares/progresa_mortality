...
- **Status: code written, NOT run.** Awaiting the user's run to see (i) whether the fixed-denominator R² actually closes the gap toward 0.65/0.67 (confirming or refuting the denominator hypothesis), and (ii) how much β₀/β₁ and their SEs move in the main spec — per the ambiguous-direction discussion above, this is a genuine "look and see," not a predicted outcome.
