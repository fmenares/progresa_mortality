...
| 4 | Correlation between Intensity_1999 and Intensity_2005 + trend×SES robustness | **Partially Done** | **Correlation (text — not yet added):** P&V fn. 18: enrol2005 explains 65% of variance in enrol1999. Proposed sentence near line 171: *"The two phases are related: in our data, Intensity_2005 explains approximately 65% of the variance in Intensity_1999 \citep[fn.~18]{parker2023conditional}, reflecting the cumulative nature of program rollout. We include β₁ to partial out later-phase effects that would otherwise contaminate β₀; its inclusion is motivated by Parker & Vogl (2023) who show that omitting it biases the early-phase estimate upward."* TODO: compute in-sample R² (`reg inten2005 inten1999 if $sample_marg`, on municipality cross-section) to verify against P&V's 65%. **Robustness (done):** `AT_ses_trend.tex` + `AF_ses_trend.pdf` — 3 specs: baseline, +trend×im_mun_1990 (continuous), +trend×1990 marg.-index quintile bins (P&V 2023 style) |
