...
* request; previously two separate tables, AT8_AT6_expenditures_elderly.tex
...
* Output: $tables/appendix/AT8_AT6_expenditures_elderly.tex
*============================================================
foreach yvar of local hh_outcomes {
    local col ""
    if "`yvar'" == "food"      local col food
...
{
    cap file close sm
    file open sm using "$tables/appendix/AT8_AT6_expenditures_elderly.tex", write replace
...
di "Table exported to: $tables/appendix/AT8_AT6_expenditures_elderly.tex"
