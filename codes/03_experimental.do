...
*============================================================
* NOTE: the experimental-attrition table formerly here
* (AT_attrition_elderly.tex, at:attrition_elderly) has moved to
* codes/04_extra_robustness.do per the coauthor's request, along
* with its tables_app.tex entry -- no longer displayed in the
* paper. The checkpoint save below captures the exact working panel
* (rondas 1/3/5, post-1997 entrants already dropped, 1997 baseline
* cohort) that block's regressions ran on, so 04_extra_robustness.do
* can reload it without needing to retrace this file's own
* individual-level construction steps.
*============================================================
save "$tempFolder/working_panel_for_attrition.dta", replace
