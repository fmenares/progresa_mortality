...
foreach outcome in $individuals {
	...
	reghdfe `outcome' c.inten1998#i.post [pweight=exp_factor] if ///
	`outcome'_out == 0 & $sample_marg & inrange(year, 1992, 2000), ///
	a(year cve_ent_mun_super) cluster(cve_ent_mun_super)
...
foreach outcome in $individuals {
	...
	reghdfe `outcome' c.inten1998#i.post [pweight=exp_factor] if ///
	`outcome'_out == 0 & $sample_marg & inrange(year, 1992, 2000) & female == 1, ///
	a(year cve_ent_mun_super) cluster(cve_ent_mun_super)
...
foreach outcome in $individuals {
	...
	reghdfe `outcome' c.inten1998#i.post [pweight=exp_factor] if ///
	`outcome'_out == 0 & $sample_marg & inrange(year, 1992, 2000) & female == 0, ///
	a(year cve_ent_mun_super) cluster(cve_ent_mun_super)
...
foreach outcome in $hh {
	...
	reghdfe `outcome' c.inten1998#i.post [pweight=exp_factor] if ///
	hh_unique == 1 & `outcome'_out == 0 & $sample_marg & inrange(year, 1992, 2000), ///
	a(year cve_ent_mun_super) cluster(cve_ent_mun_super)
...
foreach outcome in $hh {
	...
	reghdfe `outcome' c.inten1998#i.post [pweight=exp_factor] if ///
	hh_unique == 1 & `outcome'_out == 0 & $sample_marg & inrange(year, 1992, 2000) & hhh_female == 1, ///
	a(year cve_ent_mun_super) cluster(cve_ent_mun_super)
...
foreach outcome in $hh {
	...
	reghdfe `outcome' c.inten1998#i.post [pweight=exp_factor] if ///
	hh_unique == 1 & `outcome'_out == 0 & $sample_marg & inrange(year, 1992, 2000) & hhh_female == 0, ///
	a(year cve_ent_mun_super) cluster(cve_ent_mun_super)
...

{
		...
		*file write sm "& \multicolumn{4}{c}{Schock 2003-2008} & \multicolumn{4}{c}{Shock 2003-2013} \\ "_n
		...
		file write sm "& (1) & (2) & (3) & (4) & (5) & (6) & (7)  \\  \toprule"_n
file write sm "\underline{\textit{Panel A: Pooled}}  \\  "_n
		file write sm "\textit{Intensity 1998 x continuous (1998-2002)} & `OLS_wc_1'  & `OLS_wc_2' & `OLS_wc_3' & `OLS_wc_4' & `OLS_wc_5' & `OLS_wc_6' & `OLS_wc_7'\\  "_n
		...
		file write sm "  & & &  & & & &  \\ "_n
file write sm "\underline{\textit{Panel B: Females}}  \\  "_n
		file write sm "\textit{Intensity 1998 x continuous (1998-2002)} & `OLS_fc_1'  & `OLS_fc_2' & `OLS_fc_3' & `OLS_fc_4' & `OLS_fc_5' & `OLS_fc_6' & `OLS_fc_7'\\  "_n
		...
		file write sm "  & & &  & & & &  \\ "_n
file write sm "\underline{\textit{Panel C: Males}}  \\  "_n
		file write sm "\textit{Intensity 1998 x continuous (1998-2002)} & `OLS_mc_1'  & `OLS_mc_2' & `OLS_mc_3' & `OLS_mc_4' & `OLS_mc_5' & `OLS_mc_6' & `OLS_mc_7'\\  "_n
...

{
		...
		*file write sm "& \multicolumn{4}{c}{Schock 2003-2008} & \multicolumn{4}{c}{Shock 2003-2013} \\ "_n
		...
		file write sm "& (1) & (2) & (3) & (4) & (5) & (6) & (7) & (8)  \\  \toprule"_n
file write sm "\underline{\textit{Panel A: Pooled}}  \\  "_n
		file write sm "\textit{Intensity 1998 x continuous (1998-2002)} & `OLS_wc_1'  & `OLS_wc_2' & `OLS_wc_3' & `OLS_wc_4' & `OLS_wc_5' & `OLS_wc_6' & `OLS_wc_7' & `OLS_wc_8'\\  "_n
		...
		file write sm "Obs & `N_w1'  & `N_w2' & `N_w3' & `N_w4' & `N_w5' & `N_w6' & `N_w7' & `N_w8' \\ "_n
			file write sm "  & & &  & & & & & \\ "_n
file write sm "\underline{\textit{Panel B: Females}}  \\  "_n
		file write sm "\textit{Intensity 1998 x continuous (1998-2002)} & `OLS_fc_1'  & `OLS_fc_2' & `OLS_fc_3' & `OLS_fc_4' & `OLS_fc_5' & `OLS_fc_6' & `OLS_fc_7' & `OLS_fc_8'\\  "_n
		...
		file write sm "Obs & `N_f1'  & `N_f2' & `N_f3' & `N_f4' & `N_f5' & `N_f6' & `N_f7' & `N_f8' \\ "_n
			file write sm "  & & &  & & & & & \\ "_n
file write sm "\underline{\textit{Panel C: Males}}  \\  "_n
		file write sm "\textit{Intensity 1998 x continuous (1998-2002)} & `OLS_mc_1'  & `OLS_mc_2' & `OLS_mc_3' & `OLS_mc_4' & `OLS_mc_5' & `OLS_mc_6' & `OLS_mc_7' & `OLS_mc_8'\\  "_n
