...
twoway ///
	...
	graphregion(color(white)) ///
	plotregion(margin(l=1 r=1))
graph export "$figures/appendix/Figure_4_BR__pooled.pdf", as(pdf) replace
restore


*============================================================
* APPENDIX FIGURE 5: Event Study by Cause of Death
...
foreach cod in tb_card tb_infect tb_diab tb_resp tb_nutri tb_cancer tb_accid tb_illdef tb_other {
	...
	twoway ///
		...
		graphregion(color(white)) ///
		plotregion(margin(l=1 r=1))
	graph export "$figures/Figure_5_cod_`cod'.pdf", as(pdf) replace
	restore
...
*============================================================
* APPENDIX TABLE 4: BR Analysis Extended
*============================================================
{
...
{
	cap file close sm
	file open sm using "$tables/appendix/AT4_BR_Table_extend.tex", write replace
